(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('immutable'), require('draft-js'), require('react'), require('axios'), require('lodash'), require('draft-js-custom-styles'), require('@emotion/styled'), require('polished'), require('react-dom'), require('react-color'), require('react-select'), require('prismjs'), require('draft-js-prism'), require('draft-js-multidecorators'), require('emotion-theming')) :
  typeof define === 'function' && define.amd ? define(['immutable', 'draft-js', 'react', 'axios', 'lodash', 'draft-js-custom-styles', '@emotion/styled', 'polished', 'react-dom', 'react-color', 'react-select', 'prismjs', 'draft-js-prism', 'draft-js-multidecorators', 'emotion-theming'], factory) :
  (global.Dante = factory(global.Immutable,global.draftJs,global.React,global.axios,global.lodash,global.createStyles,global.styled,global.polished,global.ReactDOM,global.reactColor,global.Select,global.Prism,global.PrismDecorator,global.MultiDecorator,global.emotionTheming));
}(this, (function (Immutable,draftJs,React,axios,lodash,createStyles,styled,polished,ReactDOM,reactColor,Select,Prism,PrismDecorator,MultiDecorator,emotionTheming) { 'use strict';
